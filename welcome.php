        ...
        <div class="main-container">
            ...
            <div class="aside">
                ...
                <ul class="nav">
                    ...
                    <li><a href="#portfolio"><i class="fa fa-briefcase"></i>Users</a></li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="home-info padd-15">
                                <h3 class="hello">Hello, my name is <span class="name">Josh</span></h3>
                                <h3 class="my-profession">I'm a <span class="typing">Web Designer</span></h3>
                                <p>I'm a web designer with extensive experience for over 10 years. My expertise is to create websites, website design, graphic design and many more...</p>
                                <a href="#" class="btn">Download CV</a>
                            </div>
                            <div class="home-img padd-15">
                                <img src="images/2014660.png" alt="">
                            </div>
                        </div>
                    </div>
                </section>
                            ...
                            <div class="about-content padd-15">
                                <div class="row">
                                    <div class="about-text padd-15">
                                        <h3>I'm Josh and <span>Web Developer</span></h3>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui sed odit dolore quaerat possimus ut blanditiis veniam ratione nostrum atque. Officiis inventore, commodi nam qui exercitationem velit at possimus asperiores.</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="personal-info padd-15">
                                        <div class="row">
                                            ...
                                            <div class="info-item padd-15">
                                                <p>Phone : <span>+201212065237</span></p>
                                            </div>
                                            <div class="info-item padd-15">
                        ...
                        <div class="row">
                            ...
                            <div class="service-item padd-15">
                                <div class="service-item-inner">
                                    ...
                                    <h4>IOS Dev</h4>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos, obcaecati? Totam, sequi earum rerum illum maxime, officia atque placeat dolore praesentium quis recusandae provident tempora ipsa natus magni delectus, quam sit cumque saepe ratione facere! Iure exercitationem enim minus laborum atque assumenda, ut dolorem aliquid obcaecati voluptates itaque doloremque provident iste dolore fugit adipisci ducimus.</p>
                                </div>
                            </div>
                            <!-- ==== Service item End ==== -->
                            <!-- ==== Service item Start ==== -->
...
<a href="view_portfolio.php?id=<?php echo $user_id; ?>" class="portfolio-item padd-15">
